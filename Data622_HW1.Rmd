...
Bagging model and kNN model with k=3  has the best performance in training data, it has the best ability to learn compared with LOOCV.

Interestingly,LOOCV performs better for KNN=5,but performs worse for NB in testing data.
Bagging and Loocv do not do better than simpler models in both training data and testing data.
